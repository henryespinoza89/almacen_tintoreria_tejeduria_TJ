...
<script type="text/javascript">
  $(function(){
    ...
    $("#export_excel").click(function(){
      url = '<?php echo base_url(); ?>administrador/export_tabla_detalle_producto';
    ...
    <?php if(!empty($respuesta_registro_satisfactorio)){ ?>
      $("#error_respuesta_registro_satisfactorio").html('<strong>! Se realizo satisfactoriamente el Registro de '+ fila_producto + ' Filas !</strong>').dialog({
        ...
        buttons: { Ok: function(){
          window.location.href="<?php echo base_url();?>administrador/gestion_detalle_producto";
        }}
      });
    <?php } ?>
...
<body>
  <div id="contenedor">
    <div id="tituloCont">Exportar Tabla detalle_producto</div>
    <div id="formFiltro">
      <div id="options_productos">
      <form id="formulario" action="<?php echo base_url('administrador/insert_tabla_detalle_producto');?>" enctype="multipart/form-data" method="post" style="background: whitesmoke;padding-left: 15px;padding-top: 12px;margin-top: 0px;">
