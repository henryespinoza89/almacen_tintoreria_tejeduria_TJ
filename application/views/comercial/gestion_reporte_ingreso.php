...
<body>
  <div id="contenedor">
    ...
    <div id="formFiltro">
      <?php echo form_open(base_url()."comercial/reporteingresospdf", 'id="reporteingresospdf"') ?>
      ...
      <?php echo form_close() ?>
      <?php echo form_open(base_url()."comercial/reporteingreso_producto_pdf", 'id="reporte_filtro_producto"') ?>
        ...
        <?php echo form_close() ?>
        <?php echo form_open(base_url()."comercial/reporteingreso_agente_pdf", 'id="reporte_filtro_agente"') ?>
          <table width="481" border="0" cellspacing="0" cellpadding="0">
            <tr>
