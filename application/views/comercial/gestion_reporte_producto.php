...
<body>
  <div id="contenedor">
    <div id="tituloCont" style="margin-bottom: 0px;">Gestión de Reporte de Productos</div>
    <div id="formFiltro">
      <?php echo form_open(base_url()."comercial/reporteproductospdf", 'id="reporteproductospdf"') ?>
