...
<body>
  <div id="contenedor">
    <div id="tituloCont" style="margin-bottom:0px;">Gestión de Reporte de Salida de Productos</div>
    <div id="formFiltro">
      <?php echo form_open(base_url()."comercial/reportesalidapdf", 'id="reportesalidapdf"') ?>
        ...
        <?php echo form_close() ?>
        <?php echo form_open(base_url()."comercial/reportesalida_solicitante_pdf", 'id="reporte_filtro_asistente"') ?>
