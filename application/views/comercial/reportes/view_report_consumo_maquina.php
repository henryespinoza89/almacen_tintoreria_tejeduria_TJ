    ...
    <div id="contenedor">
    	...
    	<div id="formFiltro" style="background: whitesmoke;padding-top: 5px;padding-left: 15px;padding-bottom: 15px;border-bottom: 1px solid #000;">
			<table width="1050" border="0" cellspacing="0" cellpadding="0" style="margin-top: 25px;margin-bottom: 20px;">
				<tr>
	                <td width="180" height="30" style="padding-bottom: 5px;">Fecha de Inicio:</td>
	                <td width="230" height="30"><?php echo form_input($fechainicial);?></td>
	                <td width="150" height="30" style="padding-bottom: 5px;">Fecha Final:</td>
	                <td width="230" height="30"><?php echo form_input($fechafinal);?></td>
					<td width="285" valign="middle" style="width: 120px;padding-bottom: 5px;">Máquina:</td>
		          	<?php
