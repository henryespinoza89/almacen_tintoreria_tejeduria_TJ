...
<script type="text/javascript">
	$(function(){
		...
		$("#report_kardex_excel").click(function(){
    		...
    		if( fechainicial == '' || fechafinal == '' || indice == ''){
	    		...
	    		url = '<?php echo base_url(); ?>comercial/al_exportar_kardex_producto_excel_general/'+jObject;
		...
		$("#indice").append('<option value="" selected="selected">:: SELECCIONE ::</option>');
...
<body>
	...
	<div id='preloader'>
		<header>
			<h1 style="position: absolute;margin-left: 45.5%;margin-top: 120px;">Cargando</h1>
		</header>
    ...
    <div id="contenedor" style="">
    	<div id="tituloCont" style="margin-bottom:0px;width: 1380px;">Gestión de Kardex General</div>
    	<div id="formFiltro" style="background: whitesmoke;padding-top: 5px;padding-left: 15px;padding-bottom: 15px;border-bottom: 1px solid #000;">
			<table width="1000" border="0" cellspacing="0" cellpadding="0" style="margin-top: 15px;">
				<tr>
	                ...
	                <td width="140" height="30">Indice de Distribución:</td>
                	<td><?php echo form_dropdown('indice',$indice,'','id="indice"');?></td>
