...
<body>
  <div id="contenedor" style="width:1160px;">
    <div id="tituloCont" style="margin-bottom:0px;">Gestión de Reporte de Ingresos de Productos sin Factura</div>
    <div id="formFiltro">
      <?php echo form_open(base_url()."gerencia/reporteingresospdf_otros", 'id="reporteingresospdf_otros"') ?>
      ...
      <?php echo form_close() ?>
      <?php echo form_open(base_url()."gerencia/reporteingreso_producto_pdf_otros", 'id="reporte_filtro_producto_otros"') ?>
