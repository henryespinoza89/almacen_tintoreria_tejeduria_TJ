...
<body>
  <div id="contenedor" style="width:1160px;">
    ...
    <div id="formFiltro">
      <?php echo form_open(base_url()."gerencia/reporteingresospdf_otros_tejeduria", 'id="reporteingresospdf_otros"') ?>
      ...
      <?php echo form_close() ?>
      <?php echo form_open(base_url()."gerencia/reporteingreso_producto_pdf_otros_tejeduria", 'id="reporte_filtro_producto_otros"') ?>
