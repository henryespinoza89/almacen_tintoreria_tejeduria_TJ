...
<body>
  <div id="contenedor" style="width: 1150px;">
    ...
    <div id="formFiltro">
      <?php echo form_open(base_url()."gerencia/reporteingresospdf_tejeduria", 'id="reporteingresospdf"') ?>
      ...
      <?php echo form_close() ?>
      <?php echo form_open(base_url()."gerencia/reporteingreso_producto_pdf_tejeduria", 'id="reporte_filtro_producto"') ?>
        ...
        <?php echo form_close() ?>
        <?php echo form_open(base_url()."gerencia/reporteingreso_agente_pdf_tejeduria", 'id="reporte_filtro_agente"') ?>
          <table width="481" border="0" cellspacing="0" cellpadding="0">
            <tr>
