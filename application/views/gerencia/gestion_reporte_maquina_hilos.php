...
<body>
  <div id="contenedor" style="width: 1150px;">
    <div id="tituloCont" style="margin-bottom: 0px;width: 1200px;">Gestión de Reporte de Máquinas</div>
    <div id="formFiltro">
      <?php echo form_open(base_url()."gerencia/reportemaquinaspdf_hilos", 'id="reportemaquinapdf"') ?>
