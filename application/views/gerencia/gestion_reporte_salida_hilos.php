...
<script type="text/javascript">
  $(function(){
    ...
    $("#maquina option:selected").each(function() {
            maquina = $('#maquina').val();
            $.post("<?php echo base_url(); ?>gerencia/traeMarca_hilos", {
    ...
    $("#marca option:selected").each(function() {
            marca = $('#marca').val();
            $.post("<?php echo base_url(); ?>gerencia/traeModelo_hilos", {
    ...
    $("#modelo option:selected").each(function() {
            modelo = $('#modelo').val();
            $.post("<?php echo base_url(); ?>gerencia/traeSerie_hilos", {
...
<body>
  <div id="contenedor" style="width: 1150px;">
    ...
    <div id="formFiltro">
      <?php echo form_open(base_url()."gerencia/reportesalidapdf_hilos", 'id="reportesalidapdf"') ?>
        ...
        <table style="float: left; margin-top: 5px; width: 300px; margin-left: 0px;">
          <tr>
            <td style="height:30px; color:#005197;" colspan="2"><b>Filtrar Consulta por Área</b></td>
          </tr>
          <tr>
        ...
        <?php echo form_close() ?>
        <?php echo form_open(base_url()."gerencia/reportesalida_solicitante_pdf_hilos", 'id="reporte_filtro_asistente"') ?>
