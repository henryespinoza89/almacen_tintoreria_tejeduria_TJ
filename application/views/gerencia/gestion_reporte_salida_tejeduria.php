...
<script type="text/javascript">
  $(function(){
    ...
    $("#modelo option:selected").each(function() {
            modelo = $('#modelo').val();
            $.post("<?php echo base_url(); ?>gerencia/traeSerie_tejeduria", {
...
<body>
  <div id="contenedor" style="width: 1150px;">
    ...
    <div id="formFiltro">
      <?php echo form_open(base_url()."gerencia/reportesalidapdf_tejeduria", 'id="reportesalidapdf"') ?>
        ...
        <?php echo form_close() ?>
        <?php echo form_open(base_url()."gerencia/reportesalida_solicitante_pdf_tejeduria", 'id="reporte_filtro_asistente"') ?>
