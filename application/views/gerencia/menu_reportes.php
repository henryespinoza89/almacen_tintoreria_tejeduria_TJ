		                      ...
		                      success: function(msg){
		                        if(msg == 1){
		                          $("#finregistro").html('!La Contraseña ha sido regristado con éxito!.').dialog({
		                            ...
		                            buttons: { Ok: function(){
		                              window.location.href="<?php echo base_url();?>gerencia/redirect_store_staClara";
		                            }}
		                          });
		                        }else{
...
<header style="width: 1300px; margin-top: 20px;">
	...
	<header>
		<div id="menucomercial" style="margin-left: 30px;">
			<div id="cssmenu">
				<ul class="nav">
					<li><a href='<?php echo base_url();?>gerencia/redirect_store_staClara'><span>Reporte de Maquinarias</span></a></li>
					<li><a href='<?php echo base_url();?>gerencia/redirect_store_staClara_producto'><span>Reporte de Productos</span></a></li>
					<li><a href='<?php echo base_url();?>gerencia/redirect_store_staClara_proveedor'><span>Reporte de Proveedores</span></a></li>
					<li><a href='<?php echo base_url();?>gerencia/redirect_store_staClara_ingreso'><span>Reporte de Ingreso de Facturas</span></a></li>
					<li><a href='<?php echo base_url();?>gerencia/redirect_store_staClara_ingreso_otros'><span>Reporte de Ingreso Comprobantes</span></a></li>
					<li><a href='<?php echo base_url();?>gerencia/redirect_store_staClara_salida'><span>Reporte de Salida de Productos</span></a></li>
				</ul>
			</div>
		</div>
	</header>
